...
Item multi-select:
https://learn.microsoft.com/en-us/office/dev/add-ins/outlook/item-multi-select?tabs=jsonmanifest

Activate reading pane by default:
https://learn.microsoft.com/en-us/office/dev/add-ins/outlook/contextless?tabs=jsonmanifest
...
async function getItemInfo(selectedItems) {
  ...
  //addToList("Grand Total items: " + icount.toString());
}
...
function addToList(item) {
  ...
  //listItem.textContent +=  "Total items: " + icount.toString();  
  icount++;
}
...
function appendToListItem(data) {
  ...
  listItem.textContent +=  "Item count: " + icount.toString();  
   //addToList("1Grand Total items: " + icount.toString());
}
